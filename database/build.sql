...
--   `doctor_id` INT DEFAULT NULL COMMENT '外键，主治医生id',
...
CREATE TABLE `consultation_apply` (
  ...
  `project_apply` TEXT DEFAULT NULL COMMENT '申请会诊项目',
  ...
  `is_consultation` TINYINT DEFAULT NULL COMMENT '是否会诊：0 未会诊 1已会但需病患详细信息 2得出结果 3未得出结果',
